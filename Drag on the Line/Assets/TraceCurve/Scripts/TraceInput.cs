...
namespace TraceCurve
{
    public class TraceInput : MonoBehaviour
    {
        ...
        private void OnDown()
        {
            ...
            {
                var rect = new Rect((Vector2)TracePainter.BrushRectTransform.position - TracePainter.BrushBoundsSize, TracePainter.BrushBoundsSize + TracePainter.BrushExtraBounds);
            ...
            {
                var bounds = new Bounds((Vector2)TracePainter.BrushObject.transform.position, TracePainter.BrushBoundsSize + TracePainter.BrushExtraBounds);
